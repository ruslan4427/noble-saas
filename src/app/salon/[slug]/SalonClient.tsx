...
const TRANSLATIONS = {
  en: {
    ...
    emailNotice: 'You will receive a confirmation by email and SMS reminder before your appointment.',
  ...
  es: {
    ...
    emailNotice: 'Recibirás una confirmación por correo y un recordatorio por SMS antes de tu cita.',
                    ...
                    {allSlots.map(({ time, available }) => (
                      <button
                        ...
                        className={`flex flex-col items-center justify-center gap-0.5 py-2 rounded-xl text-sm font-semibold border transition min-h-[52px] ${
                          !available
                            ? 'border-[#ccc5bc] bg-[#ddd5c8] text-[#9e9388] pointer-events-none opacity-50'
                            : selectedTime === time
              ...
              <div className="space-y-4 mb-5">
                ...
                <label className="flex items-start gap-3 cursor-pointer select-none">
                  <input
                    ...
                    className="mt-0.5 w-4 h-4 rounded border-[#c8bfb0] accent-[#C9A84C] flex-none cursor-pointer"
                  />
                  <span className="text-xs text-[#6b5744] leading-relaxed">{t.smsConsent}</span>
                </label>
